...
class OpParent(models.Model):
    ...
    motherwork = fields.Char(string="Mother's Work")
    fatherwork = fields.Char(string="Father's Work")
    address = fields.Char(string="Address")
    emergency = fields.Integer(string="Emergency Contact")
    user_id = fields.Many2one('res.users', related='name.user_id',
                              string='User', store=True)
    student_ids = fields.Many2many('op.student', string='Students Details')
